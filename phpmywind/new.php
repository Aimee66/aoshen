...
<body>
	...
	<div class="box-nav"></div>
		...
		<div class="container">
			<div class="row">
			<?php $dosql->Execute("SELECT * FROM `#@__infolist` WHERE classid=16 AND delstate='' AND checkinfo=true ORDER BY orderid asc LIMIT 0,3");
				...
				<div class="new-top">
				    ...
				    <div class="col-lg-9 col-lg-9">
						<div class="new-right">
							<ul>
								<li class="li1"><a href="#"><?php echo $row['title']; ?></a></li>
